...
export const competencies: Competency[] = [
  ...
  c(
    ...
    "platform",
    "Admin roles",
    "Separation of duties across super, security, billing, audit.",
  ),
  c(
    "plat.feature_controls",
    "platform",
    "Feature controls",
    "Progressive rollout, model pickers, connector toggles.",
  ),
  ...
  c(
    ...
    "platform",
    "Release management",
    "Vendor release notes, breaking changes, comms.",
  ),
  ...
  c(
    ...
    "platform",
    "Offboarding",
    "Access removal, ownership transfer, data return/deletion.",
  ),
  c(
    "plat.usage_analytics",
    "platform",
    "Usage analytics",
    "Adoption, active users, cohort trends.",
  ),
  ...
  c(
    ...
    "governance",
    "AI registry",
    "Portfolio inventory, ownership, lifecycle state.",
  ),
  c(
    "gov.risk_classification",
    "governance",
    "Risk classification",
    "Inherent risk tiering criteria.",
  ),
  c(
    "gov.review_applicability",
    "governance",
    "Review applicability",
    "Which reviews apply to which use cases.",
  ),
  c(
    "gov.capability_governance",
    "governance",
    "Capability governance",
    "Governing model, RAG, agent capabilities.",
  ),
  c(
    "gov.agent_governance",
    "governance",
    "Agent governance",
    "Agent lifecycle, tools, approvals, recert.",
  ),
  c(
    "gov.evidence_management",
    "governance",
    "Evidence management",
    "Collecting, storing, and reviewing evidence.",
  ),
  ...
  c(
    ...
    "governance",
    "Exceptions",
    "Risk-accepted exceptions with expiry and owners.",
  ),
  c(
    "gov.recertification",
    "governance",
    "Recertification",
    "Periodic re-review of active AI assets.",
  ),
  ...
  c(
    ...
    "Frontend → gateway → app → orchestrator → model.",
  ),
  ...
  c(
    "sec.mitre_thinking",
    "security",
    "MITRE-style threat thinking",
    "Adversary TTP reasoning for AI.",
  ),
  c(
    "sec.prompt_injection",
    "security",
    "Prompt injection",
    "Direct injection detection & mitigation.",
  ),
  c(
    "sec.indirect_injection",
    "security",
    "Indirect prompt injection",
    "Injection via retrieved or tool content.",
  ),
  ...
  c(
    ...
    "privacy_legal_risk",
    "PII classification",
    "Identifying and tiering personal data.",
  ),
  c(
    "plr.minimization",
    "privacy_legal_risk",
    "Data minimization",
    "Collect and expose the minimum needed.",
  ),
  c(
    "plr.purpose",
    "privacy_legal_risk",
  ...
  c(
    ...
    "privacy_legal_risk",
    "Residency",
    "Geographic constraints on data & processing.",
  ),
  ...
  c(
    ...
    "privacy_legal_risk",
    "Deletion",
    "Verified deletion across systems and indexes.",
  ),
  ...
  c(
    "plr.client_restrictions",
    "privacy_legal_risk",
    "Client restrictions",
    "Contractual data-use limits.",
  ),
  ...
  c(
    ...
    "privacy_legal_risk",
    "Risk acceptance",
    "When and how to accept residual risk.",
  ),
  ...
  c(
    ...
    "privacy_legal_risk",
    "Responsible AI",
    "Fairness, transparency, contestability.",
  ),
